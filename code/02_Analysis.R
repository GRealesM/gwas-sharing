...
# ggsave("../figures/Figure1.tiff",height=6,width=7,units="in", bg="white")
# ggsave("../figures/Figure1.png",height=6,width=7,units="in", bg="white")
...
plot_grid(top,bot,nrow=1, labels = "auto")
 ...
 # ggsave("../figures/Figure2.tiff",height=6,width=12,units="in", bg="white")
 # ggsave("../figures/Figure2.png",height=6,width=12,units="in", bg="white")
...
# ggsave("../figures/R2_figure3_updated.tiff",height=8,width=14,units="in", bg ="white")
# ggsave("../figures/R2_figure3_updated.png",height=8,width=14,units="in", bg ="white")
...
# Save Table S6
# fwrite(xjournal, "../tables/R2_S6_Journals_table.tsv", sep="\t")
...
# Save Table S4 complement
# fwrite(sigtable2, "../tables/R2_S4_complement_updated.tsv", sep = "\t")
...
# Save table S5 complement
# fwrite(sigtable1, "../tables/S5_complement_updated.tsv", sep = "\t")
